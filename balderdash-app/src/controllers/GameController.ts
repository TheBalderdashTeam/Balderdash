...
export class GameController {
  static async createGame(req: Request, res: Response) {
    try {
      const { hostUserId, numberRounds, timeLimitSeconds, statusId } = req.body;
      const game = await GameService.createGame(hostUserId, numberRounds, timeLimitSeconds, statusId);
