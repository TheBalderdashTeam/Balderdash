...
export class AuthPage extends HTMLElement {
    ...
    this.shadow.innerHTML = `
      <style>
       ...
       :root {
            ...
            --text-rgb-130-130-130: rgb(148, 144, 144);
        }
        ...
        .text-rgb-130-130-130 {
            color: var(--text-rgb-130-130-130);
        }
        ...
        .divider {
            ...
            gap: 1rem; /* smaller gap between lines and text */
            margin: 2rem 0;
        }
        
        .divider hr {
            width: 200px; /* set a fixed shorter width */
            border: none;
  ...
  .gsi-material-button:not(:disabled):hover .gsi-material-button-state {
    ...
    opacity: 8%;
      ...
      <section aria-label="Auth Divider" class="divider">
     <hr aria-hidden="true" />
     <p>Continue with</p>
     <hr aria-hidden="true" />
    ...
    <button class="gsi-material-button">
      <section class="gsi-material-button-state"></section>
      <section class="gsi-material-button-content-wrapper">
        <section class="gsi-material-button-icon">
        ...
        <p class="gsi-material-button-contents">Google</p>
      </section>
    </button>
    </vertical-container-h>
    `;
